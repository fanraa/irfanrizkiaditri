...
const firebaseConfig = {
  apiKey: process.env.VITE_FIREBASE_API_KEY || "AIzaSyDjgrBvKUaVg9U1XustHj9TeO4lHZDrcNg",
  authDomain: process.env.VITE_FIREBASE_AUTH_DOMAIN || "fanra-dev.firebaseapp.com",
  projectId: process.env.VITE_FIREBASE_PROJECT_ID || "fanra-dev",
  storageBucket: process.env.VITE_FIREBASE_STORAGE_BUCKET || "fanra-dev.firebasestorage.app",
  messagingSenderId: process.env.VITE_FIREBASE_MESSAGING_SENDER_ID || "664735861834",
  appId: process.env.VITE_FIREBASE_APP_ID || "1:664735861834:web:6519570201553dbe4faab3",
  measurementId: process.env.VITE_FIREBASE_MEASUREMENT_ID || "G-HMKEVZS65H"
};
